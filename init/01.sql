...
# Database: mini_imdb
# Generation Time: 2021-08-25 21:33:00 +0000
# ************************************************************
...
CREATE TABLE `films` (
  ...
  `audience_score` int DEFAULT NULL,
  `profitability` varchar(255) DEFAULT NULL,
  `rotten_tomatoes_score` int DEFAULT NULL,
  `ww_gross` varchar(255) DEFAULT NULL,
...
CREATE TABLE `comments` (
  ...
  `comment` text,
  PRIMARY KEY (`id`),
  KEY `film_id_to_id` (`film_id`),
  CONSTRAINT `film_id_to_id` FOREIGN KEY (`film_id`) REFERENCES `films` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

LOCK TABLES `films` WRITE;
/*!40000 ALTER TABLE `films` DISABLE KEYS */;

INSERT INTO `films` (`id`, `title`, `genre`, `lead_studio`, `audience_score`, `profitability`, `rotten_tomatoes_score`, `ww_gross`, `year`)
VALUES
